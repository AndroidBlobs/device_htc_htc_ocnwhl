...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/htc_audio_effects.conf:$(TARGET_COPY_OUT_VENDOR)/etc/htc_audio_effects.conf \
    $(LOCAL_PATH)/configs/audio/htc_sound_mfg.txt:$(TARGET_COPY_OUT_VENDOR)/etc/htc_sound_mfg.txt \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/gps/gps.conf_BOOST000:$(TARGET_COPY_OUT_VENDOR)/etc/gps.conf_BOOST000 \
    $(LOCAL_PATH)/configs/gps/gps.conf_PREPAID0:$(TARGET_COPY_OUT_VENDOR)/etc/gps.conf_PREPAID0 \
    $(LOCAL_PATH)/configs/gps/gps.conf_SPRINT00:$(TARGET_COPY_OUT_VENDOR)/etc/gps.conf_SPRINT00 \
    $(LOCAL_PATH)/configs/gps/gps.conf_VM000000:$(TARGET_COPY_OUT_VENDOR)/etc/gps.conf_VM000000 \
    $(LOCAL_PATH)/configs/gps/gps.conf_default:$(TARGET_COPY_OUT_VENDOR)/etc/gps.conf_default \
...
# Inherit vendor
$(call inherit-product, vendor/htc/htc_ocnwhl/htc_ocnwhl-vendor.mk)